  ...
  return (
    <Box component="main" sx={{ flexGrow: 1, p: 3 }}>
      ...
      <Typography variant="body1">
        Sorry, we couldn't find what you're looking for! Is the path <code>{pathname}</code>{" "}
        correct?
      </Typography>
    </Box>
  );
...
export function ArticleNotFound() {
  return (
    <Typography variant="body1">Sorry, we couldn't find the article you're looking for!</Typography>
  );
}
